        ...
        return (
            <div className="portfolio-page-main-div container-fluid">
                <div className="container portfolioDivHead">
                    ...
                    <p>NOTE: Secure API Managment instances should be secured by requiring Subscriptions to APIs. This API does not require Subscriptons and is for demonstration purposes only.</p>
                    <h5>
                    ...
                    <p>The Demo is a "pick out of a hat" simulation. Where you can <i>Pick a Number, Pick a food recipe</i> or <i>Pick a board game</i> out of a hat. 
                    You can pick out of a hat for the number, recipe and board game picker. You can also add board games and food recipes to their respective hats.
                     Both the recipe and board game hats start with default data and are periodically cleaned of newly added data.</p>
                    ...
                    <p className="repourl"><strong>Python Function - Boardgame Picker</strong> has a GET endpoint for getting random boardgames and a POST endpoint for creating new boardgames that can be randoming picked.</p>
                    <p className="repourl"><strong>JavaScript Function - Boardgame Picker</strong> has a GET endpoint for getting random recipes where both the food type and the url to the recipe is given and a POST endpoint for creating new recipes that can be randoming picked.</p>
